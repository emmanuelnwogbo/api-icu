...
var _populations = _interopRequireDefault(require("./populations"));
...
var API_REQUEST_INTERVAL = 40 * 1000; // 30 seconds

app.use(_express["default"]["static"]('public'));
app.use((0, _cors["default"])()); // add this line

app.use(_express["default"].urlencoded({
  extended: false
}));
var ExtractedDataRoute = _routes["default"].ExtractedDataRoute,
  PoloniexDateRoute = _routes["default"].PoloniexDateRoute,
  GetUniswapData = _routes["default"].GetUniswapData,
  TransactionRoute = _routes["default"].TransactionRoute;
