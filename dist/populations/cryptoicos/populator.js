...
function convertAndExtract(htmlString) {
  ...
  var cleanedString = htmlString.replace(/\\"/g, '"').replace(/\\n/g, '');

  // Convert the cleaned HTML string to plain text
  var plainText = htmlToText(cleanedString);
  return plainText;
}
          ...
          return _regeneratorRuntime().wrap(function _callee$(_context) {
            while (1) switch (_context.prev = _context.next) {
              ...
              case 7:
                ...
                console.error('Failed to save item:', item, 'Error:', _context.t0);
              case 10:
              case "end":
...
var filePath = path.join(__dirname, 'outputjson2.json');
